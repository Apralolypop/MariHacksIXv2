...
#We are planning on using an Hyberpolic Ellipse to approximate the phase space of a pendulum, which is a closed curve.Looping through possible values of a and b, we can quickyl find the best fit through binary search.
L = 1
g = 9.8
